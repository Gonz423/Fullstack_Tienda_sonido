...
function buscarProductoPorCodigo(codigoBuscado) {
    for (const producto of catalogoInstrumentos) {
...
function filtrarProductosPorCategoria(categoriaBuscada) {
...
function verificarStock(codigoBuscado, cantidadRequerida) {
    const producto = buscarProductoPorCodigo(codigoBuscado);
    if (producto === null) {
        return false;
    }
